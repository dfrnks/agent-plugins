...
| Distribution | Git repo `deepcloud-dev/agent-plugins`; native plugin install for Claude Code, install script for Cursor |
...
```
/plugin marketplace add deepcloud-dev/agent-plugins
