Derive the project's own conventions from the codebase, write them into the project's conventions file, and extend the review checklist alongside them.
...
Follow `$PIPELINE_ROOT/core/flows/conventions.md`.
